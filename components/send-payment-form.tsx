      ...
      <div className="flex-1 flex items-start justify-start px-4 py-6 sm:px-6 lg:px-8 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mb-12 sm:mb-16">
            <label className="block font-semibold text-gray-900 mb-4 sm:mb-5 text-lg">
          ...
          <div className="mb-16 sm:mb-20">
            <label className="block font-semibold text-gray-900 mb-4 sm:mb-5 text-lg">Amount</label>
            <div
            ...
            >
              ...
              <span
                className="text-sm sm:text-base font-medium flex-shrink-0 whitespace-nowrap text-foreground"
              ...
              <button
                ...
                className="px-3 sm:px-4 py-2 text-sm sm:text-base font-medium hover:bg-blue-50 rounded-lg transition-colors flex-shrink-0 whitespace-nowrap text-foreground"
              >
                Max
              </button>
            </div>
